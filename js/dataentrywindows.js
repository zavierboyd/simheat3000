$(document).ready(function(){
    ...
    var winarea = $("#pywinarea").val()
    var winconductance = $("#pywinconductance").val()
    ...
    setTable("#winarea",winarea,"n")
    setTable("#winconductance",winconductance,"n")

    $("#house").submit(function(){
        elems=["area","temps","names","capacity","conductance","winconductance","winarea"]
